...
- Short press during a critical air-quality alert: snooze the alert sound and critical value focus for 30 seconds.
...
When a critical air-quality tone is active, a short button press snoozes the alert sound for a short period and returns control to the normal page flow.
