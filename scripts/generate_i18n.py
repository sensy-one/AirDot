...
SETUP_PAGE_KEYS = (
    ...
    "custom_thresholds_title",
    "custom_thresholds_description",
    "custom_thresholds_note",
    "custom_thresholds_order_error",
    "custom_threshold_balanced_label",
    "custom_threshold_moderate_label",
    "custom_threshold_poor_label",
    "custom_threshold_unhealthy_label",
    ...
    "flight_radar_traffic_military_label",
    "weather_title",
    "weather_note",
    "weather_sync_title",
    ...
    "auto_page_switch_title",
    "auto_page_switch_description",
    "auto_page_switch_mode_label",
    "auto_page_switch_mode_all_label",
    "auto_page_switch_mode_custom_label",
    "auto_page_switch_screens_label",
    "auto_page_screen_summary_label",
    "auto_page_screen_time_weather_label",
    "auto_page_screen_flight_radar_label",
    "auto_page_screen_pm1_label",
    "auto_page_screen_pm25_label",
    "auto_page_screen_pm4_label",
    "auto_page_screen_pm10_label",
    "auto_page_screen_co2_label",
    "auto_page_screen_voc_label",
    "auto_page_screen_nox_label",
    "auto_page_screen_temperature_label",
    "auto_page_screen_humidity_label",
    "auto_page_screen_pressure_label",
    "auto_page_screen_light_label",
    "update_interval_label",
    "night_screen_off_title",
    "night_screen_off_description",
    "night_screen_mode_label",
    "night_screen_mode_off_label",
    "night_screen_mode_dim_label",
    "hazard_focus_title",
