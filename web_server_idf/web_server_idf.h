...
class AsyncWebServerRequest {
 ...
 public:
  ...
  AsyncWebServerResponse *beginResponse(int code, const char *content_type) {
    auto *res = new AsyncWebServerResponseEmpty(this);
  ...
  AsyncWebServerResponse *beginResponse(int code, const char *content_type, const std::string &content) {
    auto *res = new AsyncWebServerResponseContent(this, content);
    this->init_response_(res, code, content_type);
    return res;
  }
  ...
  AsyncWebServerResponse *beginResponse(int code, const char *content_type, const uint8_t *data,
    ...
    auto *res = new AsyncWebServerResponseProgmem(this, data, data_size);
    this->init_response_(res, code, content_type);
    return res;
  }
...
class AsyncEventSourceResponse {
 ...
 protected:
  ...
  static constexpr uint16_t MAX_CONSECUTIVE_SEND_FAILURES = 2500;
};
